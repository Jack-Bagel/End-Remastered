...
public class EyeDynamicBakedModel implements BakedModel {
    ...
    public EyeDynamicBakedModel(BakedModel originalModel, Function<ResourceLocation, BakedModel> modelResolver) {
        this.originalModel = originalModel;
        this.overrides = new EyeItemOverrides(originalModel, modelResolver);
    }
